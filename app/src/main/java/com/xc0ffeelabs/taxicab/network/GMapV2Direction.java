...
public class GMapV2Direction extends AsyncTask<String, Void, Document> {
    ...
    private final RouteReady routeReady;

    public interface RouteReady {
        void onRouteReady(Document document);
    }

    public GMapV2Direction(LatLng start, LatLng end, RouteReady routeReady) {
        this.start = start;
        this.end = end;
    ...
    protected void onPostExecute(Document document) {
        routeReady.onRouteReady(document);
    }
